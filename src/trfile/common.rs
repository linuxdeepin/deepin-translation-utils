...
impl TrFileKind {
    ...
    pub fn from_ext_hint(path_hint: &Path) -> Result<Self, UnknownTrExtError> {
        ...
        match ext {
            ...
            Some(s) => Err(UnknownTrExtError { ext: s.to_string() }),
            None => Err(UnknownTrExtError { ext: String::new() }),
        }
    }
}
